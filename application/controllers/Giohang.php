...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='STORE MỸ PHẨM - Giỏ Hàng Của Bạn';
    ...
    function check_mail(){
        ...
        {
            $this->form_validation->set_message(__FUNCTION__, 'Email Đã Là Thành Viên, Vui Lòng Đăng Nhập Hoặc Nhập Email Khác !');
            return FALSE;
        }
        return TRUE;
    }
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='STORE MỸ PHẨM - Thông Tin Đơn Hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Hệ thống Mỹ Phẩm Toàn Quốc');
        ...
        $this->data['title']='STORE MỸ PHẨM - Kết Quả Đơn Hàng';
