...
<script src="./public/css/owl.carousel.js"></script> 
...
<div class="container" style="margin-top: 5px;">
    <div class="sale-title" style="background:#e5677d">
        <span> <b>SẢN PHẨM KHUYẾN MÃI HOT</b></span>
    </div>
</div>
<script>
...
<div  class="container" style="margin-bottom: 20px;">
    <div id="owl-test" class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #e5677d;" >
        <?php 
...
<div class="container" style="margin-top: 20px;">
    <div class="sale-title" style="background:#e5677d">
        <span><b>SẢN PHẨM BÁN CHẠY</b></span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #e5677d;" data-ride="carousel">
        <?php 
    ...
    <div class="container">
        ...
        <div class="blog-content">
            ...
            foreach ($listBaiViet as $rowPost) :?>
                <div class="col-xs-12 col-12 col-sm-6 col-md-4 col-lg-4" style="margin: 5px;display: block; margin-left: auto; margin-right: auto">
                    <div class="latest" style="width:80% ; display: block; margin-left: auto; margin-right: auto">
                        <a href="tin-tuc/<?php echo $rowPost['alias'] ?>">
                            <div class="tempvideo" >
                                <img src="public/images/posts/<?php echo $rowPost['img'] ?>">
                            </div>
