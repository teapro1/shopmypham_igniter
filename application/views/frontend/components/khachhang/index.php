    ...
    <div class="container account">
        ...
        <div class="col-main col-md-9 col-sm-12">
            ...
            <div class="table-order">
                        ...
                        <?php foreach ($products as $row):?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 16px;">
                                    <a style="color: #0f9ed8; text-decoration: underline;" href="<?php echo base_url($row['alias'].'/') ?>"><?php echo $row['name'] ?></a>
                ...
                <?php if($i == 0){ ?>
                    <br>
                    <p class="text-center">Danh Sách Hàng Của Bạn Đang Trống!</p>
                <?php } ?>
            </div>
        </div>
    </div>
