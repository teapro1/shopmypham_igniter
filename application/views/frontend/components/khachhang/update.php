        ...
        <div class="col-main col-md-9 col-sm-12">
            <div class="my-account">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row d-flex justify-content-between mb-3 ">
                      <div class="col-md-7">
                        <label for="tsp" class="form-label">Mô Tả <span>(*)</span> </label>
                    ...
                    <div class="row d-flex justify-content-between mb-3 ">
                      <div class="col-md-8">
                        <label for="detail" class="form-label">Chi Tiết <span>(*)</span></label>
                      ...
                      <div class="col-md-3">
                          ...
                          <div class="col-md-12">
                              ...
                              <?php if($product[0]['status'] == 1){ ?>
                                <input type="text" id="slb" class="form-control" disabled value="Đang Bán">
                              <?php }else{ ?>
                                <input type="text" id="slb" class="form-control" disabled value="Chưa Được Bán">
                              <?php } ?>
                          </div>
                      </div>
                    </div>
