...
<div class="content-wrapper">
	<form action="<?php echo base_url() ?>admin/product/update.html" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
		<section class="content-header">
			<h1><i class="glyphicon glyphicon-cd"></i> Cập Nhập Loại Sản Phẩm</h1>
							...
							<div class="col-md-5">
								<div class="form-group">
									...
									<select name="status" class="form-control" style="width:300px">
										...
										<option value="1" <?php if($row['status'] == 1) {echo 'selected';}?> >Đang Bán Hàng</option>
										<option value="0" <?php if($row['status'] == 0) {echo 'selected';}?>>Đang Tạm Ngưng</option>
									</select>
								</div>
							</div>
						</div>
