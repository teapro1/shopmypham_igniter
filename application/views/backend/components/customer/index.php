								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $row):?>
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/customer/trash/<?php echo $row['id'] ?>" onclick="return confirm('Xác Nhận Xoá Thông Tin Khách Hàng Này ?')" role = "button">
