								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center">Áp Dụng Đơn Hàng Có Giá Trị Từ</th>
									...
									<?php foreach ($list as $row):?>
										<tr>
											...
											<td class="text-center"><?php echo number_format($row['payment_limit'])?>đ</td>
											<td class="text-center"><?php if($row['orders'] == 1)
